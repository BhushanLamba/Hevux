...
import com.softbrain.hevix.adapters.StockLedgerAdapter
import com.softbrain.hevix.adapters.WalletLedgerAdapter
import com.softbrain.hevix.databinding.ActivityStockLedgerBinding
...
class StockLedgerActivity : AppCompatActivity() {
    private lateinit var binding: ActivityStockLedgerBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityStockLedgerBinding.inflate(layoutInflater)
    ...
    private fun filterData(searchKey: String) {
        val filteredList = ArrayList<StockLedgerModel>()
    ...
    private fun getWalletLedger() {
        ...
        RetrofitClient.getInstance().api.getStockLedger(userId, fromDate, toDate)
                        ...
                        try {
                            ...
                            if (responseCode.equals("TXN", ignoreCase = true)) {
                                ...
                                for (position in 0 until transactionsArray.length()) {
                                    ...
                                    val oldStock = transactionObject.getString("OldStock")
                                    val stock = transactionObject.getString("Stock")
                                    val newStock = transactionObject.getString("NewStock")
                                ...
                                ledgerAdapter = StockLedgerAdapter(dataList)
